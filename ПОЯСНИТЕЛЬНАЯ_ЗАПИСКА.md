...
> **Примечание:** Полный SQL DDL скрипт также вынесен в отдельный файл:
> `KnowledgeForKnowledgeLite/Scripts/00_init_database.sql`
...
> **Примечание:** Все SQL DML запросы также вынесены в отдельный файл:
> `KnowledgeForKnowledgeLite/Scripts/02_dml_queries.sql`
...
> **Примечание:** Все транзакции также вынесены в отдельный файл:
> `KnowledgeForKnowledgeLite/Scripts/03_transactions.sql`
